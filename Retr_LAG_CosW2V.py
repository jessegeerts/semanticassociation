...
mat = spio.loadmat('sfmCosSR.mat', squeeze_me=True)  # for list of words {'SPIDER', 'LIQUID', 'DIAMOND' 'IRON', 'BUBBLE', 'MOMENT', 'SUBJECT' , 'RESEARCH', 'FINGER' , 'BUTTON', 'SUCCESS', 'FAILURE'};
cosDist = mat['sfmCos']
